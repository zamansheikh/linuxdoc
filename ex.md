...
```bash
curl -sSL https://raw.githubusercontent.com/zamansheikh/linuxdoc/main/sdk-setup.sh | bash
```
...
```bash
wget -qO- https://raw.githubusercontent.com/zamansheikh/linuxdoc/main/sdk-setup.sh | bash
```
...
```bash
wget https://raw.githubusercontent.com/zamansheikh/linuxdoc/main/sdk-setup.sh
...
```bash
curl -sSL https://raw.githubusercontent.com/zamansheikh/linuxdoc/main/sdk-setup.sh | sudo bash
```
